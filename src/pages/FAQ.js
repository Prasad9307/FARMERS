              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    ...
                    Setu website or Krishi Setu mobile applications.
                  </span>
                </details>
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    Listing on Krishi Setu is quite easy. Just click on the
                ...
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    ...
                    Krishi Setu website or mobile applications. Don’t forget
              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  ...
                  <span class="px-4 py-2 text-justify">
                    ...
                    providers are open to selling equipment on Krishi Setu
                    with a fair deal.
                  </span>
                </details>
                <details class="mb-4">
                  <summary class="font-semibold  bg-gray-200 rounded-md py-2 px-4">
                    I don't have a website, Can I still sell on Krishi Setu?
                  </summary>

                  <span class="px-4 py-2 text-justify">
                    You don't need a website to start selling on Krishi Setu.
